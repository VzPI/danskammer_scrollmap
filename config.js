...
//section 3
      {
            ...
            image: 'https://i.imgur.com/JaDkhzF.png',
...
//section 5
      {
            ...
            description: "Danskammer's coal past predominates present site conditions. By way of comparison, the ash pits that were active in this 1994 UGSG aerial image would undergird Danskammer's grafted energy center. While Danskammer reassures the public that its ash pits are 'fully monitored', there is scant information in the application regarding their mitigation and final cleanup. As is well known, the plant was inundated by Hurricane Sandy, yet Danskammer elects to construct in the same location with the unconvincing assertion that new facilities will remain outside of the 100/500-year floodplains and account for NYSDEC 2017 sea level rise guidance. Critically however, Danskammer fails to consider the coincidence of both: as sea levels rise, so to do floodplains.  Danskammer further failed to disclose that its floodplain assumptions are based on a FEMA FIRM product from 2009 - now more than a decade out-of-date and absent of sea level rise assumptions - a known deficiency of FEMA floodplain designations.</p><p>References:</p><p><a href='https://slate.com/technology/2017/09/heres-why-femas-flood-maps-are-so-terrible.html'>Why Are FEMA’s Flood Maps So Horribly Flawed?</a></p>",
            location: {
...
//section 7
      {
            ...
            image: 'https://i.imgur.com/llFvctm.png',
            description: 'FERC, The Federal Energy Regulatory Commission, is the primary driver of both gas pipelines and the markets in which they operate. Even as it hands over operation of the markets to Regional Transmission Organizations (RTOs), the FERC has ultimate jurisdiction.  In 2014, FERC established the <i>New Capacity Zone</i> (NCZ), what is referred today as the <i>G-J Locality</i>, covering all NYC 5 boroughs and northern territories to Hudson Valley. In the map at right, the grey-blue territory is the zone; the bright blue lines represent transmission lines within the zone.  The <i>G-J Locality</i> was hotly contested by New York State as it would, and indeed has, raised rates precipitously in <i>downstate</i> New York.  Not by accident, this is where fracked gas plants have proliferated simply because they can make huge profits via the inflated zone rate, just as Danskammer intends to do. All the while, actual demand for the generation capacity remains steady, even decreases year-over-year into 2030+. The chart above, based on the New York Independent System Operator (NYSIO) 2019 modeling for the <i>G-J Locality</i> (inclusive of the Indian Point Nuclear Plant 2020-21 closure) 2009 - 2039, hardly makes the case for expanded gas generation over the next 10 - 15 years.<p>References:</p><p><a href="https://www.nyiso.com/documents/20142/2226333/2019-Gold-Book-Final-Public.pdf/">NYSIO 2019 Load & Capacity Data - Gold Book</a></p>',
                location: {
